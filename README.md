...
## Results & Discussion
In this chapter, we will focus on the results of the "Kind of Job Offer" and "Sector" groupings, which we believe are the most insightful.
...
We can aim to compare different groups by studying the particular case-oriented plots. For example, being “Data Scientist” the group of most interest for me, we can take a look at the same kind of plot, but filtering the data to obtain the sorted 20 most common skills for that group.
